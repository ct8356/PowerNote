...
namespace PowerNote {
    public class ListBoxPanel : StackPanel {
        ...
        public void autoCompleteBox_SelectionChanged(object sender, RoutedEventArgs e) {
            ...
            (DataContext as ListBoxPanelVM<object>).addSelectedItem(autoCompleteBox.SelectedItem);
        ...
        public virtual void updateControls() {
            ListBox.ItemsSource = (DataContext as ListBoxPanelVM<object>).SelectedObjects; //SHOULD WORK!
            AutoCompleteBox.ItemsSource = (DataContext as ListBoxPanelVM<object>).Objects;
            //LISTBOX
